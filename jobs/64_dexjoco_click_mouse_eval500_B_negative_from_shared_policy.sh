...
export DEXJOCO_EVAL_POLICY_DIR="${DEXJOCO_EVAL_POLICY_DIR:-/share/home/u23133/.cache/recap-sim-l40-stage/dexjoco_click_mouse_eval500_existing_policy_20260619_210959/checkpoints/B_r03_1199}"
...
export DEXJOCO_EVAL_PROMPT="negative"
export DEXJOCO_EVAL_NAME="${DEXJOCO_EVAL_NAME:-B_base_collect_eval500_negative_prompt}"
