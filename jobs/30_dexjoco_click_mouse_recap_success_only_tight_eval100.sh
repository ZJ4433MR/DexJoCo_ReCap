...
# Success-only, tighter high-advantage ReCap run for click_mouse.
# Compared with v6, this removes failed trajectories from policy fine-tuning,
# uses exact top-k advantage positives, strengthens ACP-positive replay, and
# evaluates on 100 episodes to reduce small-sample noise.
...
export DEXJOCO_RECAP_EXP_NAME="${DEXJOCO_RECAP_EXP_NAME:-recap_success_only_tight_eval100}"
