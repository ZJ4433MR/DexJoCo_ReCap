...
# Diffusion PuSH-T run with ReCap as ACP-weighted fine-tuning from the BC
# checkpoint. This keeps full trajectory coverage and mildly upweights
# ACP-positive samples.
...
export TAG="${TAG:-pusht_recap_diffusion_weighted_ft}"
