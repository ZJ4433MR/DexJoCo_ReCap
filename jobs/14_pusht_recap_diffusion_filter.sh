...
# Diffusion-policy PuSH-T run for the ACP/ReCap simulation.
# Compared with the earlier ACT run, this uses the policy family commonly used
# for PuSH-T and makes the ReCap branch sample only ACP-positive frames.
...
export TAG="${TAG:-pusht_recap_diffusion_filter}"
export POLICY_TYPE="${POLICY_TYPE:-diffusion}"
export BATCH_SIZE="${BATCH_SIZE:-64}"
export POLICY_STEPS="${POLICY_STEPS:-40000}"
export VALUE_STEPS="${VALUE_STEPS:-3000}"
